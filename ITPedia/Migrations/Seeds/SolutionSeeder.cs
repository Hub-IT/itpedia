...
namespace ItPedia.Migrations.Seeds
{
    public class SolutionSeeder
    {
        public SolutionSeeder(ItPediaDbContext context)
        {
            ...
            var transactionCriteriaUpTo100 = context.TransactionCriterias.First(i => i.PerMonth == "Up to 100");
            var transactionCriteriaMoreThan100 = context.TransactionCriterias.First(i => i.PerMonth == "More than 100");
